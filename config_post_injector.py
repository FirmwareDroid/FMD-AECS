...
NAME_EXECUTION_MAPPING_TIME_LOG = "results_post_build_injector_mapping.json"
...
NAME_INJECTION_TIME_LOG = "results_injection_metrics.json"
PATH_INJECTION_TIME_LOG = os.path.join(BUILD_OUT_PATH, NAME_INJECTION_TIME_LOG)
