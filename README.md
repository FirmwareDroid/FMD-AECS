...
**Note**: Most configurations use templates and are generated by the startup scripts. The `env/.env` file primarily contains TURN server credentials for WebRTC functionality.
