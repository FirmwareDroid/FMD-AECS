...
def get_module_type(source_file_path, pre_injector_package_list=None, post_injector_config=None):
    ...
    if (tmp_module_type == "APPS" and (file_name in POST_INJECTOR_CONFIG["ALLOW_APP_INJECT_ALWAYS"]
            or any(keyword in source_file_path for keyword in
                   POST_INJECTOR_CONFIG["ALLOW_APP_INJECT_ALWAYS_KEYWORD_LIST"]))):
        logging.info(
