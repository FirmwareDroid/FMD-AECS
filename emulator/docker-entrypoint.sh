...
# Redirect all TCP / UDP traffic to mitmproxy SOCKS5
iptables -t nat -A PREROUTING -p tcp -j REDIRECT --to-port 8050
iptables -t nat -A PREROUTING -p udp -j REDIRECT --to-port 8050
