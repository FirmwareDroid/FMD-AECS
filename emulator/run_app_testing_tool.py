...
def parse_args():
    ...
    parser.add_argument('--mode', choices=['basic', 'droidrun', 'single', 'monkey', 'ape', 'fastbot', 'kea2', 'pipeline'], default='basic', help='Mode to run inside containers (ignored if individual tool flags provided)')
