...
ANDROID_12_EMULATOR_SHARED_LIBRARIES = [
    ...
    "android.frameworks.cameraservice.device@2.1.so",
    ...
    "android.frameworks.stats-V1-ndk_platform.so",
    ...
    "android.hardware.audio.common@7.0-util.so",
    "android.hardware.audio.common@7.0.so",
    "android.hardware.audio.effect@4.0-util.so",
    ...
    "android.hardware.audio.effect@7.0-util.so",
    "android.hardware.audio.effect@7.0.so",
    "android.hardware.audio@4.0-util.so",
    ...
    "android.hardware.audio@7.0-util.so",
    ...
    "android.hardware.gnss-V1-cpp.so",
    ...
    "android.hardware.power-V2-cpp.so",
    ...
    "android.hardware.security.secureclock-V1-cpp.so",
    ...
    "android.security.compat-ndk_platform.so",
    "android.security.legacykeystore-ndk_platform.so",
    "android.security.maintenance-ndk_platform.so",
    "android.system.keystore2-V1-cpp.so",
    ...
    "android.system.suspend.control-V1-ndk.so",
    ...
    "liblayers_proto.so",
    "liblazy_static.dylib.so",
    "libldacBT_abr.so",
    "libldacBT_enc.so",
    "liblibc.dylib.so",
    "liblibprofcollectd.dylib.so",
    "liblibz_sys.dylib.so",
    "liblockagent.so",
    "liblog.dylib.so",
    "liblog.so",
    "liblogwrap.so",
    ...
    "libnfc-nci.so",
    "libnfc_nci_jni.so",
    "libnum_integer.dylib.so",
    "libnum_traits.dylib.so",
    ...
    "libperfetto.so",
    "libperfetto_android_internal.so",
    "libpermission.so",
    "libpiex.so",
    "libpng.so",
    ...
    "libpower.so",
    "libpowermanager.so",
    "libppv_lite86.dylib.so",
    "libprintspooler_jni.so",
    "libprocessgroup.so",
    "libprocessgroup_setup.so",
    "libprocinfo.so",
    "libprofcollectd_aidl_interface.dylib.so",
    ...
    "libserde.dylib.so",
    "libserde_json.dylib.so",
    "libservices.so",
    "libsfplugin_ccodec.so",
    "libsfplugin_ccodec_utils.so",
    "libshmemcompat.so",
    "libshmemutil.so",
    "libsimpleperf_profcollect.so",
    ...
    "libunwindstack.so",
    "libupdate_engine_stable-V1-cpp.so",
    "libusbhost.so",
    "libutils.so",
    ...
    "netd_aidl_interface-V6-cpp.so",
    "netd_aidl_interface-V7-cpp.so",
