...
IMAGE_ARTEFACTS_ARM64_PATH = "/image_artefacts/x86_64/"
IMAGE_ARTEFACTS_X86_64_PATH = "/image_artefacts/x86_64/"
IMAGE_ARTEFACTS_PATH = "/image_artefacts/"
AOSP_BUILD_OUT_SDKx86_64_PATH = "out/host/linux-x86/sdk/sdk_phone_x86"
...
FMD_APP_ID_QUERY_TEMPLATE = '{"query": "query GetAppIds {android_app_id_list_by_firmware(objectIdList: [\\\"${' \
                            'firmware_id}\\\"])}",' \
