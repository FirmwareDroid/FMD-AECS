...
TEMPLATE_PATH = os.path.join(ROOT_PATH, TEMPLATE_FOLDER)
...
SUPPORTED_LUNCH_TARGETS = ["sdk_phone_x86_64-userdebug",  # Android 11 / 12 / 13 "sdk_x86_64-userdebug"
                           ...
                           "sdk_phone64_arm64-uq3a-userdebug",  # Android 14 -> sdk_phone64_arm64-ap2a-userdebug
...
PATH_BUILD_FILE_LOG = os.path.join(TMP_PATH, NAME_BUILD_FILE_LOG)
PATH_BUILD_FILE_ARTEFACT_LOG =  os.path.join(TMP_PATH, NAME_BUILD_ARTEFACT_LOG)
PATH_BUILD_INJECTOR_LOG = os.path.join(TMP_PATH, NAME_BUILD_INJECTOR_LOG)
PATH_BUILD_ACV_LOG = os.path.join(TMP_PATH, NAME_BUILD_ACV_LOG)
RESULTS_FILE_PATH_LIST = [PATH_BUILD_FILE_LOG, PATH_BUILD_FILE_ARTEFACT_LOG, PATH_BUILD_INJECTOR_LOG, PATH_BUILD_ACV_LOG]
PATH_BUILD_ACV_ERROR_LOG = os.path.join(BUILD_OUT_PATH, NAME_BUILD_ACV_ERROR_LOG)

TMP_TEMPLATE_PATH = os.path.join(TMP_PATH, TEMPLATE_FOLDER)
FILE_CONTEXT_TEMPLATE_PATH = os.path.join(TMP_PATH, TEMPLATE_FOLDER, "file_contexts")
APEX_PRIVATE_KEY_PATH = os.path.join(TMP_PATH, TEMPLATE_FOLDER, "apex.key")
APEX_PUBKEY_PATH = os.path.join(TMP_PATH, TEMPLATE_FOLDER, "apex.x509.pem")
BUILD_RETRY_COUNT = 1
